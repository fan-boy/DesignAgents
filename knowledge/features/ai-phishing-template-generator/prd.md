...
- **View-only state:** a role without create permission sees the library with no Create New Asset action and an explicit "View-only access" indicator; row actions are limited to viewing.
